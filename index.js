const jokes = [
    ...
    {
        "pun": "Q: Why was the keyboard so tired?",
        "punchline": "A: Because it has two shifts every day!"
    },
    {
    ...
    {
        "pun": "Q: What’s an aliens favorite key?",
    ...
    {
        "pun": "Q: Why did the router and the laptop get married?",
        "punchline": "A: Because they had a connection!"
    },
    {
        "pun": "Q: How does Bill Gates count to 10?",
        "punchline": "A: 1, 2, 3, 3.1, 95, 98, ME, 2000, XP, Vista, 7, 8, 10!"
    },
    {
        "pun": "Q: What did the CPU say when it was being overclocked?",
        "punchline": "A: “Stop it! It hertz so much!”"
    },
    {
        "pun": "Q: What's a programmers' favorite dessert?",
        "punchline": "A: Raspberry Pi!"
    },
    {
        "pun": "Q: Why did you get fired from your job at the keyboard factory?",
        "punchline": "A: They told me I wasn't putting in enough shifts!"
    },
    {
        "pun": "Q: What do you call an iPhone that isn't kidding around?",
        "punchline": "A: Siri-ous!"
    },
    {
        "pun": "Q: Why is it that programmers always confuse Halloween with Christmas?",
        "punchline": "A: Because 31 OCT = 25 DEC!"
    },
    {
        "pun": "Q: What do hackers do on a boat?",
        "punchline": "A: Phishing!"
    },
    {
        "pun": "Q: What’s the best way to learn programming?",
        "punchline": "A: Bit by bit..."
    },
    {
        "pun": "Q: Why do programmers always use the dark theme in IDEs?",
        "punchline": "A: Because light attracts bugs!"
    },
    {
        "pun": "Q: What did the programmer shout at the unjust ruling in court?",
        "punchline": "A: [object Object]"
    },
    {
        "pun": "Q: Why didn't the shelf compile?",
        "punchline": "A: It was missing a bracket!"
    },
    {
        "pun": "Why didn't the programmer finish their class work?",
        "punchline": "They were Test-Driven..."
    },
    {
        "pun": "Q: Why did the computer go to the opticians?",
        "punchline": "A: It needed to improve its web-sight!"
    },
    {
        "pun": "Q: What do you get when you cross a computer with an elephant?",
        "punchline": "A: A very big memory!"
    },
    {
        "pun": "Q: Why are JavaScript interviews so unpredictable?",
        "punchline": "A: You never know how a candidate will React!"
    },
    {
        "pun": "Q: What do you call a group of 8 rabbits?",
        "punchline": "A: A rabbyte!"
    },
    {
        "pun": "Q: How do you catch a C# framework?",
        "punchline": "A: With a .NET!"
    },
    {
        "pun": "Q: Why did the computer show up at work late?",
        "punchline": "A: It had a hard drive."
    },
    {
        "pun": "Q: Why did the developer go broke?",
        "punchline": "A: They used up all their cache!"
    },
    {
        "pun": "Q: What did C++ say to C?",
        "punchline": "A: You have no class!"
    },
    {
        "pun": "Q: Why are there not great movies about databases?",
        "punchline": "Because everyone already hates the SQL!"
    },
    {
        "pun":"Q. What jungle animal has only two states – jumping out and scaring people or not.",
        "punchline":"A Boo-lion"
    },
    {
        "pun": "Q. Why shouldn't you use \"beef stew\" as a password?",
        "punchline":"It's not stroganoff"
    }
]
...
//
// if(document.getElementsByClassName("jokesContainer") === undefined){
//     output1.innerHTML = "hello";
//     output2.innerHTML = "world";
// }

function Click() {
    output1.innerHTML = jokes[8]["pun"];
    output2.innerHTML = jokes[8]["punchline"];
}
function Next() {
    currentJokeIndex++;
    if (currentJokeIndex < jokes.length) {
        const currentJoke = jokes[currentJokeIndex];
        output1.innerHTML = currentJoke["pun"];
        output2.innerHTML = currentJoke["punchline"];
    } else if (output1.innerHTML === "" && output2 !== "") {
     document.getElementById("extra").innerHTML = "hello world"
    }
}
